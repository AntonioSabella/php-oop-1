...
$movies = [
    ...
    new Movie('Blade Runner 2049', 2017,'https://image.tmdb.org/t/p/w342/2mPclQ5v9YK0eqCefvav3YsYPYI.jpg', 'English', 8.2, 'Denis Villeneuve',),
];
...
<body>
 <main>
    ...
    <div class="container-fluid bg-dark h-100">
        <div class="row row-cols-3 align-items-center h-100">
                ...
                <div class="col bg-primary">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <small><?php echo $movie->vote; ?></small>
